...
Resultado esperado: **280 passed** (18 do motor + 15 do Jira + 14 da persistência + 18 dos guardrails + 17 do dashboard + 13 do RAG + 14 da persistência em nuvem + 10 do Pix + 32 da IA + 29 do Auth/Supabase + **32 das notificações** + **25 do plano** + **16 da cobrança Pix** + **16 do perfil** + 8 da persistência de sessão + 3 da ferramenta — também validado automaticamente pelo CI).
