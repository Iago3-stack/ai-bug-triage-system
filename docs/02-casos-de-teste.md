...
Resultado esperado: **398 passed** (18 do motor + 13 do colar falha + 16 dos adaptadores Playwright/Postman + 15 do Jira + 14 da persistência + 18 dos guardrails + 17 do dashboard + 23 do RAG + 14 da persistência em nuvem + 10 do Pix + 36 da IA + 29 do Auth/Supabase + **33 das notificações** + **25 do plano** + **16 da cobrança Pix** + **16 do perfil** + **18 do GitHub** + **37 do painel do dono** + 8 da persistência de sessão + 3 da ferramenta + **19 do webhook de CI** — também validado automaticamente pelo CI).
