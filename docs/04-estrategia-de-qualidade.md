...
| **Cobertura de testes** | 82 testes `pytest` — motor (18), Jira (15), persistência (8), guardrails (14), dashboard (6), RAG (10) e nuvem/Supabase (10) — cobrindo severidade, negação, sentimento, determinismo, exportação, fuso, PII, agregações de QA, recuperação do histórico e persistência em nuvem |
