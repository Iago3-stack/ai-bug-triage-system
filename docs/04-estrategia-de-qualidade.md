...
| **Cobertura de testes** | 61 testes `pytest` — motor (18), Jira (15), persistência (8), guardrails (14) e dashboard (6) — cobrindo severidade, negação, sentimento, determinismo, exportação, fuso, PII e agregações de QA |
