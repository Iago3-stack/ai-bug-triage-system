...
| [02 — Casos de Teste](02-casos-de-teste.md) | Matriz de casos em Gherkin + os testes automatizados (264 no total, incluindo Dashboard de QA completo, RAG, nuvem/Supabase, Pix, IA com fallback Groq e modelo próprio, Auth/Supabase, notificações, plano por usuário, cobrança Pix e persistência de sessão no F5) |
