...
| [02 — Casos de Teste](02-casos-de-teste.md) | Matriz de casos em Gherkin + os testes automatizados (119 no total, incluindo Dashboard de QA completo, RAG, nuvem/Supabase, Pix e IA com fallback Groq e modelo próprio) |
