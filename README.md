...
- 🧪 **225 testes + CI** — suíte `pytest` (motor, colar falha, Jira, persistência, guardrails, dashboard, RAG, nuvem, Pix, IA, Auth/Supabase, notificações, plano e persistência de sessão) rodando a cada push via GitHub Actions (badge de qualidade em cima).
