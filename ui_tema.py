...
<style>
    ...
    [data-testid="stExpander"]:has(.marca-colar) { border: 2px solid #22c55e !important; border-radius: 12px !important; background: rgba(34, 197, 94, 0.05) !important; }
    ...
    [data-testid="stColumn"]:has(.marca-jira-expo) [data-testid="stButton"] button:hover { background-color:#0747A6 !important; color:#ffffff !important; }
...
.marca-top-logo span { background:linear-gradient(90deg,#9CC4FF 0%,#4ADE80 55%,#25D366 100%); -webkit-background-clip:text !important; background-clip:text !important; -webkit-text-fill-color:transparent; }
body:has([data-st-tema="escuro"]) .marca-top-logo span { background:none !important; color:#ffffff !important; -webkit-text-fill-color:#ffffff; }
...
body:has([data-st-tema="escuro"]) [data-testid="stExpander"]:not(:has(.marca-resolucao,.marca-sessao,.marca-historico,.marca-dashboard,.marca-diag,.marca-modelo,.marca-jira,.marca-colar,.marca-plano)) { background:transparent !important; border:1px solid #2b3443 !important; }
body:has([data-st-tema="escuro"]) [data-testid="stExpander"]:not(:has(.marca-resolucao,.marca-sessao,.marca-historico,.marca-dashboard,.marca-diag,.marca-modelo,.marca-jira,.marca-colar,.marca-plano)) summary { color:#e6ecf2 !important; }
...
body:has([data-st-tema="escuro"]) [data-testid="stExpander"]:has(.marca-colar) summary,
...
/* Botões da tela de login/cadastro — cor sólida nos dois temas, SEM hover */
[data-testid="stColumn"]:has(.marca-entrar) [data-testid="stFormSubmitButton"] button { background:#059669 !important; color:#ffffff !important; border:none !important; font-weight:700 !important; }
[data-testid="stColumn"]:has(.marca-entrar) [data-testid="stFormSubmitButton"] button:hover { background:#059669 !important; color:#ffffff !important; }
...
/* Esqueceu a senha — vermelho sólido, sem hover, mesmo tamanho dos de cima */
[data-testid="stColumn"]:has(.marca-rec) [data-testid="stButton"] button { background:#dc2626 !important; color:#ffffff !important; border:none !important; font-weight:700 !important; height:38px !important; min-height:38px !important; line-height:38px !important; padding-top:0 !important; padding-bottom:0 !important; white-space:nowrap !important; }
[data-testid="stColumn"]:has(.marca-rec) [data-testid="stButton"] button:hover { background:#dc2626 !important; color:#ffffff !important; }

/* Reenviar confirmação — azul sólido, sem hover */
