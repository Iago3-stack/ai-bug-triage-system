...
def render():
    ...
    <div style="margin-top:14px;width:100%;background:linear-gradient(135deg,#0f172a 0%,#16233c 55%,#25D366 170%);border-radius:16px;color:#e2e8f0;font-size:15px;line-height:1.6;padding:22px 24px">
      <div style="font-size:19px;font-weight:800;color:#ffffff;margin-bottom:12px">🧑🏽‍💻 O Autor — quem está por trás do sistema</div>
      <p style="margin:0 0 12px">Sou o autor do <b style="color:#25D366">AI Bug Triage System</b>. <b style="color:#94a3b8">QA Automation Engineer</b> colocando IA em produção dentro da garantia de qualidade — não em slide: motor NLP determinístico + Gemini com fallback automático (Groq), RAG, alertas multi-canal e um SaaS nativo na nuvem, rodando de verdade. Este site é o registro vivo desse processo, do código aberto ao funil de uso real.</p>
      <p style="margin:0 0 12px">🚀 <b style="color:#94a3b8">Hoje:</b> IA em produção de ponta a ponta — motor NLP determinístico + Gemini com fallback automático, aplicação pública, open-source e <b style="color:#94a3b8">container publicada no GHCR</b>.</p>
