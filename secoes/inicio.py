...
def render():
    ...
    st.markdown("""
    <div style="margin:0 0 18px;width:100%;background:linear-gradient(135deg,#0f172a 0%,#16233c 60%,#7c3aed 190%);border-radius:16px;padding:22px 26px;color:#e2e8f0">
      <h2 style="margin:0 0 8px;font-size:22px;font-weight:800;color:#ffffff;line-height:1.3">Triagem de bugs com IA para QA — classifique a severidade, priorize e gere o relatório em segundos</h2>
      <p style="margin:0 0 10px;font-size:15px;line-height:1.65">O <b style="color:#86efac">AI Bug Triage System</b> é um sistema gratuito de <b>triagem de bugs com Inteligência Artificial</b> para times de <b>QA e teste de software</b>. Cole o relato do bug e o motor <b>NLP determinístico (offline, custo zero)</b> calcula a prioridade; a IA <b>Gemini</b> (com fallback automático para <b>Groq</b>) aprofunda com <b>causa raiz</b> e plano de ação; o <b>RAG</b> busca casos similares já resolvidos; e o sistema monta o <b>relatório Gherkin pronto para JIRA e GitHub</b>, com alertas automáticos para bugs <b>críticos ou de alta severidade</b>.</p>
