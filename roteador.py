...
from secoes import inicio, ferramenta, dashboard_pagina, meu_plano, painel_dono, integracao, legal
...
PAGINAS = {
    ...
    "integracao": st.Page(integracao.render, title="Integração", url_path="integracao", icon="🔌"),
    ...
    "legal": st.Page(legal.render, title="Termos & Privacidade", url_path="legal", icon="⚖️"),
}
